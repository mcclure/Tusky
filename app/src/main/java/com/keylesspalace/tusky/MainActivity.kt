...
class MainActivity : BottomSheetActivity(), ActionButtonActivity, HasAndroidInjector, MenuProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        catch (e:ClassCastException) { preferences.edit().putFloat(PrefKeys.DECREASE_SWIPE_SENSITIVITY, preferences.getInt(PrefKeys.DECREASE_SWIPE_SENSITIVITY, -4).toFloat()).apply() }
